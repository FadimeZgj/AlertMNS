    ...
    <section>
        <div class="actions">
            <ul>
                ...
                <li><a href="/admin/groupes/new.php"><i class="fa-solid fa-plus fa-xl"></i>Créer un nouveau groupe</a></li>
...
<?php else : ?>
    ...
    <section>
        <div class="actions">
            <ul>
                <li><a href="/user/groupes/new.php"><i class="fa-solid fa-plus fa-xl"></i>Créer un nouveau groupe</a></li>
                <li><a href="/user/reunions/new.php"><i class="fa-solid fa-plus fa-xl"></i>Organiser une réunion</a></li>
                <li><a href="/search-user.php"><i class="fa-solid fa-magnifying-glass fa-xl"></i>Rechercher un utilisateur</a></li>
                <li><a href="/user/chaines"><i class="fa-solid fa-tower-cell fa-xl"></i>Voir les chaînes</a></li>
                <li><a href="/user/groupes"><i class="fa-solid fa-users fa-xl"></i>Voir les groupes</a></li>
