    ...
    <nav class="navbar">
        ...
        <div class="navbar-menu" id="menu">
            <ul class="nav navbar-nav">
                <li><a href="<?php if (in_array("Administrateur", $_SESSION['user']['roles'])) : ?> /admin <?php else : ?> /user <?php endif; ?>"><i class="fa-solid fa-house fa-2x"></i>Accueil</a></li>
                <li><a href="<?php if (in_array("Administrateur", $_SESSION['user']['roles'])) : ?> /admin/messages.php <?php else : ?> /user/messages.php  <?php endif; ?>"><i class="fa-solid fa-comment-dots fa-2x"></i>Voir tous les messages</a></li>
                <li><a href="<?php if (in_array("Administrateur", $_SESSION['user']['roles'])) : ?> /admin/groupes <?php else : ?> /user/groupes  <?php endif; ?>"><i class="fa-solid fa-users fa-2x"></i>Voir tous les groupes</a></li>
                <li>
                    <a href="<?php if (in_array("Administrateur", $_SESSION['user']['roles'])) : ?> /admin/chaines <?php else : ?> /user/chaines  <?php endif; ?>"><i class="fa-solid fa-tower-cell fa-2x"></i>Voir toutes les chaînes</a>
                </li>
                <li><a href="<?php if (in_array("Administrateur", $_SESSION['user']['roles'])) : ?> /admin/reunions <?php else : ?> /user/reunions  <?php endif; ?>"><i class="fa-regular fa-calendar-days fa-2x"></i>Voir les réunions</a></li>
