...
if (!empty($_POST['submit'])) {
    ...
    $id = insertUsersInGroups($_POST['groupe'], isset($_POST['users']) ? $_POST['users'] : []);
    ...
    <div class="container-create-reunions">
        <div class="createReunionForm">
            <form action="" method="post">
                <h1 class="createReunionTitle">Créer une nouvelle réunion (TEST)</h1>
                ...
                <div class="form-group">
                    ...
                    <?php foreach ($users as $user): ?>
                        ...
                        <input type="checkbox" name="users[]" value="<?= $user['id_utilisateur'] ?>" ">
                ...
                <div class="form-group">
                    ...
                    <a href="/admin/groupes/test.php">
                        <button name="no-group">CREER UN NOUVEAU GROUPE</button>
                    </a>
                </div>
            </div>
